"""Source-bound construction and validation of the report-only MMI view."""
...
_UPSTREAM_COMPONENT_CONTRACT_FAILURE: Final = (
    "MMI_ANALYST_VIEW_UPSTREAM_COMPONENT_CONTRACT_FAILURE"
)
_COMPONENT_CORRELATION_INVALID: Final = (
    "MMI_ANALYST_VIEW_COMPONENT_CORRELATION_INVALID"
)
_UNKNOWN_UPSTREAM_LIMITATION: Final = (
    "MMI_ANALYST_VIEW_UNKNOWN_UPSTREAM_LIMITATION"
)
...
def build_mmi_analyst_visible_evidence_view(
    *,
    ...
    """Build one in-memory, source-bound, report-only analyst view."""
    try:
...
def validate_mmi_analyst_visible_evidence_view(
    *,
