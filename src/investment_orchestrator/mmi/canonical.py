...
_MMI_VALIDATED_GROUNDED_ANALYSIS_RESPONSE_V2_IDENTITY_DOMAIN: Final = (
    b"mmi_validated_grounded_analysis_response_v2\0"
)
_MMI_LEGACY_STEP1_COMPATIBILITY_CANDIDATE_V1_IDENTITY_DOMAIN: Final = (
    b"mmi_legacy_step1_compatibility_candidate_v1\0"
)
_MMI_LEGACY_STEP1_COMPARISON_REPORT_V1_IDENTITY_DOMAIN: Final = (
...
_MMI_H2C_CASE_EVIDENCE_BUNDLE_V1_IDENTITY_DOMAIN: Final = (
    b"mmi_h2c_case_evidence_bundle_v1\0"
)
_MMI_LONG_HORIZON_RESEARCH_SOURCE_ENTRY_V1_IDENTITY_DOMAIN: Final = (
    b"mmi_long_horizon_research_source_entry_v1\0"
)
...
MAX_MMI_GROUNDED_ANALYSIS_RESPONSE_V2_CANONICAL_BYTES: Final = 245_760
MAX_MMI_LEGACY_STEP1_COMPATIBILITY_CANDIDATE_V1_CANONICAL_BYTES: Final = (
    262_144
)
...
MAX_MMI_H2C_CASE_EVIDENCE_BUNDLE_V1_CANONICAL_BYTES: Final = 1_269_095
