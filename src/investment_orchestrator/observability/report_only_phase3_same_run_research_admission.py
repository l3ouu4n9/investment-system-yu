...
def observe_same_run_report_only_phase3_research_admission(
    *,
    ...
    claims = Phase3SameRunHandoffIdentityClaims(
        qualitative_response_identity_sha256=qualitative.validated_grounded_analysis_response_identity_sha256,
        recognition_response_identity_sha256=recognition.validated_grounded_analysis_response_identity_sha256,
        recognition_mapping_report_identity_sha256=recognition.mapping_report_identity_sha256,
        selection_mapping_report_identity_sha256=h1_selection.mapping_report_identity_sha256,
    )

    val_result = validate_phase3_same_run_research_handoff_cohesion(claims)

    if val_result.status != Phase3SameRunHandoffValidationStatus.VALID:
        return _non_positive(Status.INVALID, val_result.reason_codes[0])

    # --- All validator conditions hold: positive admission. ------------------
    return Phase3SameRunResearchAdmissionObservationResult(
        schema_version=_RESULT_SCHEMA_VERSION,
        ...
        validated_grounded_analysis_response_identity_sha256=qualitative.validated_grounded_analysis_response_identity_sha256,
        mapping_report_identity_sha256=h1_selection.mapping_report_identity_sha256,
